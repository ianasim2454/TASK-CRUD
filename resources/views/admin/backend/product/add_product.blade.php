        ...
        <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="price" type="text" value="" id="example-text-input">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="discount_price" type="text" value="" id="example-text-input">
                    </div>
                </div>
